...
if (OPTION_BUILD_HANDLERS)
    set(CPACK_COMPONENT_EXAMPLES_DISPLAY_NAME "${META_PROJECT_NAME} Handlers")
    set(CPACK_COMPONENT_EXAMPLES_DESCRIPTION "Handlers for ${META_PROJECT_NAME}")
    set(CPACK_COMPONENT_EXAMPLES_DEPENDS runtime)

    set(CPACK_COMPONENTS_ALL ${CPACK_COMPONENTS_ALL} handlers)
endif()

if (OPTION_BUILD_PLUGINS)
    set(CPACK_COMPONENT_EXAMPLES_DISPLAY_NAME "${META_PROJECT_NAME} Plugins")
    set(CPACK_COMPONENT_EXAMPLES_DESCRIPTION "Plugins for ${META_PROJECT_NAME}")
    set(CPACK_COMPONENT_EXAMPLES_DEPENDS runtime)

    set(CPACK_COMPONENTS_ALL ${CPACK_COMPONENTS_ALL} plugins)
endif()
